...
export const ProjectCard = ({imgUrl,title,description}) => {
  return (
    ...
    <Link href="/" className="h-14 w-14 bg-[#181818] hover:border-white">
        <CodeBracketIcon className="h-10 w-10 text-[#ADB7BE] absolute top-1/2 let-1/2 transform -translate-x-1/2  -translate-y-1/2  cursor-pointer hover:text-white"/>
    </Link>
    </div>
