  ...
  return (
    <section className="lg:py-16">
      <div className="grid grid-cols-1 lg:grid-cols-12 sm:grid-cols-12">
        ...
        >
          <h1 className="text-white mb-4 text-4xl lg:text-6xl lg:leading-normal sm:text-5xl font-extrabold">
          ...
          <div>
            <button className="px-6 py-3 rounded-full mr-4 bg-white hover:bg-slate-200 text-white w-full sm:w-fit bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500">
              Hire Me
            </button>
